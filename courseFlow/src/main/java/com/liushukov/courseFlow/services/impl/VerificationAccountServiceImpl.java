...
public class VerificationAccountServiceImpl implements VerificationAccountService {
    ...
    public VerificationAccountServiceImpl(EmailTokenRepository emailTokenRepository, UserRepository userRepository, KafkaTemplate<Object, Object> template, ObjectMapper objectMapper) {
    ...
    public void sendVerificationEmail(User user) throws CustomException {
        try {
            ...
            String message = buildEmail(user.getFullName(), verificationUrl);
    ...
    private String buildEmail(String fullName, String token){
        return "<div style='font-family: Arial, sans-serif; font-size: 16px; color: #333;'>"
                + "<h2 style='color: #0066cc;'>Welcome to Our App, " + fullName + "!</h2>"
